...
public class GraspDotProductHeuristic extends DotProductHeuristic {
    private int k=15 ;
    private Random rand = new Random();
    
    
    public GraspDotProductHeuristic(){
        super();
    };    
    
    public GraspDotProductHeuristic(int k) {
        super();
        this.setK(k);
    }
