...
public class SimulatedPattern implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = 3460858343493307730L;
    private String generatedFrom;
    private int modelLength;
    private String timeStampName;
    
    
    public SimulatedPattern(String generatedFrom, int modelLength,
