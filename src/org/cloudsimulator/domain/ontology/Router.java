...
public class Router implements Serializable {
    ...
    private static final long serialVersionUID = 390777153501482746L;
    private static final String PATHURI = "urn:cloudicaro:Router:";
    ...
    public Router(final String localUri,
