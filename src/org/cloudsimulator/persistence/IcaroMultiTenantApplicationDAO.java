...
@Named("icaroMultiTenantApplicationDAO")
public class IcaroMultiTenantApplicationDAO extends GenericDAO {

    public List<String> getURIIcaroMultiTenantApplicationListByDataCenter(
            final String ipAddressOfKB, final String uriDataCenter) {
        String select = "select ?uri where { graph ?g { <"
                + uriDataCenter
                + "> rdf:type icr:DataCenter . ?uri rdf:type icr:IcaroMultiTenantApplication.}}";
